...
- (void)setSelectionIndicatorOffsetX:(float)X {
    CGRect frame1 = self.selectionIndicatorStripLayer.frame;
    CGRect frame2 = self.selectionIndicatorStripLayer.frame;
    frame1.origin.x = self.scrollView.contentSize.width * X;
    frame2.origin.x = self.scrollView.contentSize.width * X;
    self.selectionIndicatorStripLayer.frame = frame1;
    self.selectionIndicatorStripLayer.frame = frame2;    
}
